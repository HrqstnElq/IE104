...
!(function (e, t, n, o, r) {
	...
	return (
		...
		function (e, E) {
			...
			function rt(e) {
				E.autoScrolling &&
					(k && (e.pageY < G && p.m.up ? ae() : e.pageY > G && p.m.down && se()),
					(G = e.pageY));
			}
			function it(e, t, n) {
				var o,
			...
			function xt(e) {
				...
				return (
					(t.y =
						void 0 !== e.pageY && (e.pageY || e.pageX) ? e.pageY : e.touches[0].pageY),
					(t.x =
						void 0 !== e.pageX && (e.pageY || e.pageX) ? e.pageX : e.touches[0].pageX),
					l &&
						Oe(e) &&
						E.scrollBar &&
						void 0 !== e.touches &&
